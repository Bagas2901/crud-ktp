            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h4 class="text-dark font-weight-normal">Selamat Datang di Apliaksi<span
                                class="font-weight-bold text-primary ">Create, Read, Update, Delete KTP</span></h4>
                        <p class="text-muted">Sebelum melanjutkan ke aktivitas anda, silahkan login terlebih dahulu.
                        </p>
                        ...
                        <div class="text-center mt-5 text-small">
                            Copyright &copy; 2021 Made with 💙 By <a href="https://wa.me/6281617976739">Bagas Aruna
                                Yudhatama</a>
                        </div>
                    </div>
                </div>
